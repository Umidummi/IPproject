...
def main():
    try:
        ...
        SW = 200  # float(input('Startwert[mBar]: '))
        EW = 100  # float(input('Endwert[mBar]: '))
        schritte = 2  # int(input('Anzahl der Abtastungspunkte: '))
        druckhalten=10 #zeit in sekunden, bei der druck gehalten werden soll
